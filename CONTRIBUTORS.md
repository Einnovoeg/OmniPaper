...
- OmniPaper maintainers

Note:
- Repository history was re-initialized during sanitization, so this repository's contributor graph is not a full record of upstream authors.

## Upstream Projects With Direct Code Inclusion Or Adaptation

- CrossPoint-reader (Dave Allie + contributors)
  - https://github.com/daveallie/crosspoint-reader
  - https://github.com/daveallie/crosspoint-reader/graphs/contributors
...
- Component-level provenance: `CODE_PROVENANCE.md`
- Third-party license texts and notices: `THIRD_PARTY_NOTICES.md`
- Compliance checklist: `LICENSE_COMPLIANCE.md`
