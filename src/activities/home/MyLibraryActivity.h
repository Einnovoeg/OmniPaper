...
class MyLibraryActivity final : public Activity {
 ...
 private:
  ...
  std::string filePreviewKey;
  std::string filePreviewBmpPath;
  std::string filePreviewTitle;
  std::string filePreviewAuthor;
  bool filePreviewResolved = false;
  ...
  std::string buildSelectedFilePath() const;
  void invalidateFilePreview();
