...
class ScreenComponents {
 public:
  ...
  // Draw compact device info (date/time, battery, WiFi) in configurable top/bottom regions.
  static void drawDeviceInfoOverlay(const GfxRenderer& renderer, uint8_t overlayPosition);
};
