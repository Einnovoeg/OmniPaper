...
This guide explains how to connect your OmniPaper to WiFi and use the built-in web server to upload EPUB files from your computer or phone.

## Overview

OmniPaper includes a built-in web server that allows you to:

- Upload EPUB files wirelessly from any device on the same WiFi network
- Browse and manage files on your device's SD card
- Create folders to organize your ebooks
- Delete files and folders
- Launch selected apps and open EPUB files from the web home page

## Prerequisites

- Your OmniPaper device
- A WiFi network (or use the device hotspot mode)
- A computer, phone, or tablet connected to the **same WiFi network** (or connected to `OmniPaper` hotspot)

---

## Idle Hotspot Mode (Launcher)

OmniPaper can auto-host the web UI when sitting on the launcher:

1. Open `Settings -> System`
2. Set `Idle Hotspot Web UI` to `ON`
3. Return to launcher; the device creates hotspot `OmniPaper`
4. Connect phone/computer to that hotspot
5. Open `http://omnipaper.local/` (or AP IP)

When this mode is enabled, the web UI remains available while the launcher is active and no app is running.
...
1. Ensure your computer is connected to the **same WiFi network** as your OmniPaper
...
1. Ensure your phone/tablet is connected to the **same WiFi network** as your OmniPaper
...
- The web server is accessible from WiFi transfer mode and optional launcher idle hotspot mode
- The web server automatically stops when you leave the active web-hosting context
...
1. Press the **Back** button on your OmniPaper
