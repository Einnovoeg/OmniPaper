...
|---|---|---|---|---|
| Poodle game | https://github.com/k-natori/Poodle | No repository-wide code license declared upstream | Rules/gameplay source referenced; implementation is local in this repository | `src/activities/apps/PoodleActivity.cpp` |
| Sudoku game | https://gist.github.com/palaniraja/d5a55f9bd1f990410c8a0099844cec91 | No explicit license shown on gist page | Puzzle/gameplay source referenced; implementation is local in this repository | `src/activities/apps/SudokuActivity.cpp` |
...
| Web portal launcher mode (manual STA/AP portal) | https://github.com/paperportal/portal and https://github.com/daveallie/crosspoint-reader | (No explicit license file in referenced portal repo) / MIT | File-transfer portal workflow integrated in local launcher/webserver activities | `src/activities/network/CrossPointWebServerActivity.cpp`, `src/network/CrossPointWebServer.cpp`, `src/main.cpp` |
...
| SSH client mode | https://github.com/SUB0PT1MAL/M5Cardputer_Interactive_SSH_Client and https://github.com/ewpa/LibSSH-ESP32 | (No explicit license file in referenced SSH UI repo) / LGPL-2.1 | SSH setup/interaction workflow adapted from reference app; transport implementation uses vendored LibSSH-ESP32 | `src/activities/apps/SshClientActivity.cpp`, `src/activities/apps/SshClientActivity.h`, `lib/LibSSH-ESP32/` |
